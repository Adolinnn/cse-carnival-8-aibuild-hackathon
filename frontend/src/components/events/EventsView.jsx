    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEvents.map((event) => {
          ...
          const isRegistered = regs.some((r) => r.student_id === DEFAULT_STUDENT.student_id);
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1 text-xs text-slate-600 dark:text-slate-400 pt-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-slate-800 dark:text-slate-200">{event.date}</span> at {event.time}
                  </div>
                  <div className="flex items-center gap-2">
